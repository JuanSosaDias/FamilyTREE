...
namespace Program
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Node n1 = new Node(1, "Juan", new List<Node>(), new Persona("Juan", 12));
            Node n2 = new Node(2, "Pedro", new List<Node>(), new Persona("Pedro", 77));
            Node n3 = new Node(3, "Maria", new List<Node>(), new Persona("Maria", 20));
            Node n4 = new Node(4, "Jose", new List<Node>(), new Persona("Jose", 22));
            Node n5 = new Node(5, "Ana", new List<Node>(), new Persona("Ana", 40));
            Node n6 = new Node(6, "Luis", new List<Node>(), new Persona("Luciano", 7));
            Node n7 = new Node(7, "Luisa", new List<Node>(), new Persona("Luisa", 4));
            Node n8 = new Node(8, "Carlos", new List<Node>(), new Persona("Carlos", 3));
